    ...
    <div class="card">
        ...
        <div class="card-container">
            @foreach($turmas as $turma)
                <div class="card-card">
                    <div class="card-header text-center">{{ $turma->nome }}</div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('turma.edit', ['turma' => $turma->id]) }}">
                            <img src="{{ asset('img/editar.png') }}" alt="Editar" class="footer-img">
                        </a>
                        ...
                        <form action="{{ route('turma.destroy', ['turma' => $turma->id]) }}" method="POST">
                            ...
                            @method('DELETE')
                            <button type="submit">
                                <img src="{{ asset('img/excluir.png') }}" alt="Excluir" class="footer-img">
                            </button>
                        </form>
                    </div>
                </div>
